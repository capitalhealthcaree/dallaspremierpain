...
import SiJointInjectionsDetails from "../../components/Treatments/SiJointInjectionsDetails";
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_URL_DOMAIN}treatments/si-joint-injections`}
        />
        <meta
          name="description"
