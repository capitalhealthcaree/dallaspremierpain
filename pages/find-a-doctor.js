  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_URL_DOMAIN}find-a-doctor`}
        />
        <meta
          name="description"
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-sm-6 col-lg-4">
              <div className="doctor-item">
                <div className="doctor-top">
                  <img loading="lazy" src="/images/doctors/doctor1.jpg" alt="Doctor" />
            ...
            <div className="col-sm-6 col-lg-4">
              <div className="doctor-item">
                <div className="doctor-top">
                  <img loading="lazy" src="/images/doctors/doctor3.jpg" alt="Doctor" />
                  <Link href="/appointment">Get Appointment</Link>
                </div>
                <div className="doctor-bottom">
                  <h3>
                    <Link href="/find-a-doctor/ranjit-sandhu">
                      Ranjit Sandhu M.D.
                    </Link>
                  </h3>
                  <span>Pain Management Physician</span>
